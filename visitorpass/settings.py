...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '192.168.10.250,192.168.10.63,192.168.10.28,visitorpass.balaydalakay.com,visitorpass.topitsolutions.co.nz,localhost,127.0.0.1').split(',')
